...
бестолочь словаЗаменить (много_букав& строка, карта <много_букав, много_букав> словарь) {
    ...
    целина индексБатюшки = строка.найти_ящера("int main");
    коли(индексБатюшки>=0) {
        строка = строка.изменить_суть(строка.найти_ящера("int main"), 8, "царь_батюшка_главный");
    }
    для(целина сейчас = ноль; сейчас<длинность; сейчас++) {
        коли(!((строка.найти_ящера("cin") >= 0 && словарь[список[сейчас]] == "in") || (строка.найти_ящера("cout") >= 0 && словарь[список[сейчас]] == "out"))) {
